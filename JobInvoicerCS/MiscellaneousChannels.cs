...
namespace JobInvoicerCS
{
    ...
    public class MiscellaneousChannels : object
    {

        private MiscellaneousChannelsMiscellaneousChannel[] _itemsField;

        /// <remarks/>
        [XmlElement("MiscellaneousChannel", Form = XmlSchemaForm.Unqualified)]
        public MiscellaneousChannelsMiscellaneousChannel[] Items
        {
            get
            {
                return _itemsField;
    ...
    [XmlType(AnonymousType = true)]
    public class MiscellaneousChannelsMiscellaneousChannel : object
    {
