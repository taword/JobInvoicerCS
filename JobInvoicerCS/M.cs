...
namespace JobInvoicerCS
{
    /// <remarks />
    [Serializable]
    public partial class M : Material, INotifyPropertyChanged
    {
        ...
        public override string ToString()
        {
            return base.ToString() + string.Format
                ...
                this.A, this.bf, this.bf__2_tf, this.Cw, this.d, this.gage, this.h_tw, this.ho,
                this.Ix, this.Iy, this.J, this.k_des, this.k_det, this.k1, this.Qf, this.Qw,
                this.rts, this.rx, this.ry, this.Size, this.Sw1, this.Sx, this.Sy,
                this.T, this.tf, this.tw, this.Wno, this.wt__ft, this.Zx, this.Zy
                );
        }
    }
}
