...
namespace JobInvoicerCS
{
    ...
    [XmlRoot("H-Piles", Namespace = "", IsNullable = false)]
    public class HPiles : object
    {
        private HPilesHPile[] _items;

        /// <remarks/>
        [XmlElement("H-Pile", Form = XmlSchemaForm.Unqualified)]
        public HPilesHPile[] Items
        {
            get
            {
                return _items;
    ...
    [DebuggerStepThrough]
    [XmlType(AnonymousType = true)]
    public class HPilesHPile : object
    {
