...
namespace JobInvoicerCS
{
    ...
    public class WideFlanges : object
    {

        private WideFlangesWideFlange[] _itemsField;

        /// <remarks/>
        [XmlElement("WideFlange", Form = XmlSchemaForm.Unqualified)]
        public WideFlangesWideFlange[] Items
        {
            get
            {
                return _itemsField;
    ...
    [XmlType(AnonymousType = true)]
    public class WideFlangesWideFlange : object
    {
